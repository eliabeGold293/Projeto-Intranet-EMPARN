...
<head>
    <meta charset="UTF-8">
    <title>Deletar Área de Atuação</title>
...
<style>
    ...
    .form-container button {
        background: #e74c3c; /* vermelho para ação crítica */
        color: #fff;
        border: none;
        padding: 10px 15px;
        border-radius: 4px;
...
<body>
    ...
    <section class="form-container">
        <h2>Deletar Área de Atuação</h2>
        <form action="../apis/deletar_area.php" method="POST">
